...
def main():
    ...
    input_schema[
        DOCTXT
    ] = "SHIELD contains image preprocessing techniques that can remove adversarial perturbations."
    ...
    for name, defense in DEFENSE_MAP.items():
        ...
        options = []
        for (option_name, option_type, option_default) in _get_signature(defense):
            ...
            opt[DOCTXT] = _process_doctxt(fn_doctxts[option_name])
